...
animate_frames!(simulation.history; xlim = [0.0, simulation.L_x], ylim = [0.0, simulation.L_y], colors = Dict(:boundary => "black", :swimmer => "green"), save_as = "frames/Example_RunAndTumbleFunnels.gif")
